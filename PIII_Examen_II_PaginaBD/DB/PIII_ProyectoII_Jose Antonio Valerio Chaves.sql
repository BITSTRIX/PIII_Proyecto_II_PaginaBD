...
@clave varchar(50)
	AS
		BEGIN 
			...
			WHERE U.correoElectronico=@correo AND SA.contrasenna=@clave
		END
GO
...
AS
	BEGIN
	INSERT INTO systemAccess (usuarioID, contrasenna)VALUES (@idUsuario, @Password)
	END
GO
...
AS
	BEGIN
	UPDATE systemAccess SET contrasenna = @Password WHERE accessID = @AccessID
	END
GO
